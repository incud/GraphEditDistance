...
diff_b10 = diff_df[diff_df['b'] == 0.10].drop('b', axis=1).fillna(1000).groupby(['vertices']).mean()
diff_b05 = diff_df[diff_df['b'] == 0.05].drop('b', axis=1).fillna(1000).groupby(['vertices']).mean()
diff_b01 = diff_df[diff_df['b'] == 0.01].drop('b', axis=1).fillna(1000).groupby(['vertices']).mean()
